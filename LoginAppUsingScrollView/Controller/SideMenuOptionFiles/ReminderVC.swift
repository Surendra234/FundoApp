...
class ReminderVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Reminder Notes"
    ...
    func configureCollectionView() {
        ...
        myCollectionView.register(ListCell.self, forCellWithReuseIdentifier: "ReminderCell")
    ...
    func fetchReminderNotes() {
        ...
        NoteService.shared.getReminderNotes { note in
            self.notes = note
...
extension ReminderVC: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ReminderCell", for: indexPath) as! ListCell
